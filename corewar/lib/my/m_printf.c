...
static const char flag_base[9] = "dcsSiIxX";
static const char flag_ebase[12] = "-0123456789%";

char *(*function_base[8])(va_list ap, char *str, char *buf) =
{
    m_int, m_char, m_string, m_array, m_iarray, m_maj_iarray, m_hex, m_maj_hex
};
